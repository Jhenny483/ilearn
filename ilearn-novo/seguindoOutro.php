...
$banco = new BancoDeDados();
      ...
      $select = "SELECT idSeguido, idSeguidor FROM seguidor WHERE idSeguido = '{$_GET['idUsu']}' ORDER BY idSeg DESC";
...
<?php 
    ...
    $seguidores = "SELECT nicknameSeguido, idSeguido, idSeguidor FROM seguidor WHERE idSeguidor = '{$_GET['idUsu']}'";
